Public Class TempClass
    'All strings and comments that are used in the script are placed here.
    'Will use a different system at a later date, but this is the easiest at the moment

    'Variables first
    'Public strCommentHeaders As String
    'Public strComment01 As String
